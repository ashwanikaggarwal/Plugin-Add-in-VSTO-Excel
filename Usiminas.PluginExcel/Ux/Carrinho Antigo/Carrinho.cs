...
namespace Usiminas.PluginExcel.Ux
{
    ...
    public partial class F_Pedido
    {
        ...
        private void addItemPedidoform( InfoPlaDto item, string decendio)
        {
            ItemCarrinhoDetalhe itemCarrinhoDetalhe = new ItemCarrinhoDetalhe();
            
            itemCarrinhoDetalhe.Popular(item, decendio, idCarrinhoItem);

            itemCarrinhoDetalhe.ButtonClick += ItemCarrinhoFromDetalhe_ButtonClick;
        ...
        private void ItemCarrinhoFromDetalhe_ButtonClick(object sender, EventArgs e)
        {
